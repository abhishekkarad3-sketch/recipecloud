...
const translations: Record<LangCode, T> = {
  en: {
    ...
    nutrition: 'Nutrition Analysis', calories: 'Calories', protein: 'Protein', fat: 'Fat',
    carbs: 'Carbs', sugar: 'Sugar', fiber: 'Fiber', vitamins: 'Vitamins',
    analyzeNutrition: 'Analyze Nutrition with AI', analyzing: 'Analyzing…',
  ...
  hi: {
    ...
    nutrition: 'पोषण विश्लेषण', calories: 'कैलोरी', protein: 'प्रोटीन', fat: 'वसा',
    carbs: 'कार्बोहाइड्रेट', sugar: 'चीनी', fiber: 'फाइबर', vitamins: 'विटामिन',
    analyzeNutrition: 'AI से पोषण विश्लेषण करें', analyzing: 'विश्लेषण हो रहा है…',
    ...
    nutrition: 'التحليل الغذائي', calories: 'سعرات', protein: 'بروتين', fat: 'دهون',
    carbs: 'كربوهيدرات', sugar: 'سكر', fiber: 'ألياف', vitamins: 'فيتامينات',
    analyzeNutrition: 'تحليل التغذية بالذكاء الاصطناعي', analyzing: 'جارٍ التحليل…',
  ...
  fr: {
    ...
    nutrition: 'Analyse Nutritionnelle', calories: 'Calories', protein: 'Protéines', fat: 'Graisses',
    carbs: 'Glucides', sugar: 'Sucres', fiber: 'Fibres', vitamins: 'Vitamines',
    analyzeNutrition: 'Analyser avec IA', analyzing: 'Analyse en cours…',
    ...
    nutrition: 'Análisis Nutricional', calories: 'Calorías', protein: 'Proteínas', fat: 'Grasas',
    carbs: 'Carbohidratos', sugar: 'Azúcar', fiber: 'Fibra', vitamins: 'Vitaminas',
    analyzeNutrition: 'Analizar Nutrición con IA', analyzing: 'Analizando…',
